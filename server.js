...
const { welcomeMsg, inComingRequest } = require("./controller/Controller.");
...
app.get("/get-client-token", function (request, response) {
  ...
  const grant = new VoiceGrant({
    ...
    outgoingApplicationSid: process.env.TWILIO_ML_APP_SID,
    incomingAllow: true,
  });
...
app.post("/inComingCall", (req, res) => {
  ...
  res.send(inComingRequest(digit, req.body));
});
